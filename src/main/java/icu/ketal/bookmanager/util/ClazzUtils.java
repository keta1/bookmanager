...
public class ClazzUtils {
    ...
    private static String CLASS_FILE_PREFIX = "";
    private static final String PACKAGE_SEPARATOR = ".";

    public static List<String> getClazzName(String packageName) {
        return getClazzName(packageName, false);
    }
    ...
    public static List<String> getClazzName(String packageName, boolean showChildPackageFlag ) {
        CLASS_FILE_PREFIX = packageName.replace(PACKAGE_SEPARATOR, "/");
            ...
            while(urls.hasMoreElements()) {
                ...
                if(url != null) {
                    ...
                    if("file".equals(protocol)) {
                        ...
                        System.out.println("D:get class list form " + path);
